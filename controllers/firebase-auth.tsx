...
// sign up new user
export const handleSignupFirebase = async (email: string, password: string) => {
...
// login  user
export const handleLoginFirebase = async (email: string, password: string) => {
...
// DRY?!
const handlePopupProvider = async (provider: string) => {
...
const handleCredentialError = (error: FirebaseError) => {
